...
categoryBody.style.display = "grid"
      ...
      sortedItems.forEach((item) => {
        ...
        endpointCard.innerHTML = `<span class="method-badge">GET</span><div class="endpoint-text"><span class="endpoint-path">${item.path.split("?")[0]}</span><span class="endpoint-name">${item.name}</span></div><span class="arrow-icon">»</span>`
