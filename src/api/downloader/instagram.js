...
module.exports = function (app) {
  ...
  const HEADERS = {
    ...
    "User-Agent":
      "Mozilla/5.0 (Linux; Android 11; SAMSUNG SM-G973U) AppleWebKit/537.36 Chrome/87.0.4280.141 Mobile Safari/537.36"
  };
  ...
  function decodeData(data) {
    ...
    function decodeSegment(segment, base, length) {
      ...
      const baseSet = charSet.slice(0, base);
      const decodeSet = charSet.slice(0, length);
      ...
      while (decodedValue > 0) {
        ...
        result =
          decodeSet[decodedValue % length] +
          result;

        decodedValue =
          Math.floor(decodedValue / length);
      }
